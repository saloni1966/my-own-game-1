...
girl.debug = true;
girl.setCollider("rectangle", 0,40,30,50);
  carGroup = new Group();
}
...
if(gameState === "start"){
  ...
  text("1) Make sure the girl doesn't hit the cars." , 530,200);
  text("2) Navigate the girl with the help of arrow keys.",500,230);
  text("3) Safe walking!", 650,300 );

  text("PRESS SPACE TO START", 610,350);
...
function spawncars(){
  if(frameCount%80===0){
    ...
    car.debug = true;
    car.setCollider("rectangle",-50,-30,80,30);
